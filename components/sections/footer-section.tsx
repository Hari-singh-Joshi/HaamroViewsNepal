        ...
        <div className="border-t border-border pt-8">
          <div className="grid md:grid-cols-3 gap-6 mb-8">
            ...
            <div>
              ...
              <p className="text-sm text-muted-foreground leading-relaxed">
                By using Haamro Views Nepal, you agree to our terms and conditions. These terms govern your use of our website
                and services. We reserve the right to update these terms. Please review them periodically for any
                changes.
              </p>
            </div>
          ...
          <div className="text-center text-sm text-muted-foreground border-t border-border pt-8">
            <p>&copy; 2025 Haamro Views Nepal. All rights reserved. | Design inspired by <a href="https://portfolio-hari-singh.vercel.app/" target="_blank" rel="noopener noreferrer">
   Codeshastra
</a>
</p>
          </div>
